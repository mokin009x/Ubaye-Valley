...
public class pg_AboutWindowSetup : AssetPostprocessor
{
    ...
    {
        var entries = Array.FindAll(importedAssets, name => name.Contains("pc_AboutEntry") && !name.EndsWith(".meta"));
 ...
 */
     ...
     */
    [SerializeField] public static AdvertisementThumb[] advertisements =
    {
        new AdvertisementThumb(ABOUT_ROOT + "/Images/ProBuilder_AssetStore_Icon_96px.png",
            "http://www.protoolsforunity3d.com/probuilder/", "Build and Texture Geometry In-Editor"),
        new AdvertisementThumb(ABOUT_ROOT + "/Images/ProGrids_AssetStore_Icon_96px.png",
            "http://www.protoolsforunity3d.com/progrids/", "True Grids and Grid-Snapping"),
        new AdvertisementThumb(ABOUT_ROOT + "/Images/ProGroups_AssetStore_Icon_96px.png",
            "http://www.protoolsforunity3d.com/progroups/", "Hide, Freeze, Group, & Organize"),
        new AdvertisementThumb(ABOUT_ROOT + "/Images/Prototype_AssetStore_Icon_96px.png",
            "http://www.protoolsforunity3d.com/prototype/", "Design and Build With Zero Lag"),
        new AdvertisementThumb(ABOUT_ROOT + "/Images/QuickBrush_AssetStore_Icon_96px.png",
            "http://www.protoolsforunity3d.com/quickbrush/", "Quickly Add Detail Geometry"),
        new AdvertisementThumb(ABOUT_ROOT + "/Images/QuickDecals_AssetStore_Icon_96px.png",
            "http://www.protoolsforunity3d.com/quickdecals/", "Add Dirt, Splatters, Posters, etc"),
        new AdvertisementThumb(ABOUT_ROOT + "/Images/QuickEdit_AssetStore_Icon_96px.png",
            "http://www.protoolsforunity3d.com/quickedit/", "Edit Imported Meshes!")
    };
...
/* Recommend you do not modify these. */
    ...
    private readonly string BannerPath = ABOUT_ROOT + "/Images/Banner.png";
    ...
    public void OnEnable()
    {
        ...
        minSize = new Vector2(banner.width + 12, banner.height * 7);
        maxSize = new Vector2(banner.width + 12, banner.height * 7);
    }
    ...
    private readonly Color LinkColor = new Color(0f, .682f, .937f, 1f);
    ...
    private Vector2 scroll = Vector2.zero, adScroll = Vector2.zero;
    ...
    private void OnGUI()
    {
...

        {
            ...
            GUILayout.Label("for instant email updates, send your invoice # to", GUILayout.MinWidth(284),
                GUILayout.MaxWidth(284));
            if (GUILayout.Button("contact@procore3d.com", linkTextStyle, GUILayout.MinWidth(142),
            ...
            if (GUILayout.Button("www.procore3d.com/forum", linkTextStyle, GUILayout.MinWidth(162),
            ...
            GUILayout.Label("Click on \"Edit > Preferences\" then \"" + ProductName + "\"", GUILayout.MinWidth(276),
            ...
            if (GUILayout.Button("www.procore3d.com/" + ProductName.ToLower(), linkTextStyle, GUILayout.MinWidth(190),
        ...
        adScroll = EditorGUILayout.BeginScrollView(adScroll, false, false, GUILayout.MinHeight(AD_HEIGHT + pad),
    ...
    private void PopulateDataFields(string entryPath)
    {
        ...
        var changelogText = (TextAsset) AssetDatabase.LoadAssetAtPath(ChangelogPath, typeof(TextAsset));
