...
namespace ProGrids
{
    public static class pg_Util
    {
        ...
        private static readonly Dictionary<Transform, SnapEnabledOverride> m_SnapOverrideCache =
            new Dictionary<Transform, SnapEnabledOverride>();

        private static readonly Dictionary<Type, bool> m_NoSnapAttributeTypeCache = new Dictionary<Type, bool>();

        private static readonly Dictionary<Type, MethodInfo> m_ConditionalSnapAttributeCache =
        ...
        public static bool SnapIsEnabled(Transform t)
        {
            ...
            foreach (Component c in t.GetComponents<MonoBehaviour>())
            {
                ...
                if (m_ConditionalSnapAttributeCache.TryGetValue(type, out mi))
                {
                    if (mi != null)
                    {
                        m_SnapOverrideCache.Add(t,
                            new ConditionalSnapOverride(() => { return (bool) mi.Invoke(c, null); }));
                ...
                else
                {
                    ...
                    {
                        mi = type.GetMethod("IsSnapEnabled",
        ...
        {
            private readonly bool m_SnapIsEnabled;
