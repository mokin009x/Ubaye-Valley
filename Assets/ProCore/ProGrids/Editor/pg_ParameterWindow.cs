...
namespace ProGrids
{
    public class pg_ParameterWindow : EditorWindow
    {
        ...
        private readonly GUIContent gc_predictiveGrid = new GUIContent("Predictive Grid",
            "If enabled, the grid will automatically render at the optimal axis based on movement.");

        private readonly GUIContent gc_snapAsGroup = new GUIContent("Snap as Group",
        ...
        private void OnGUI()
        {
            ...
            var snap = editor.GetSnapIncrement();
            ...
            var snapAsGroup = editor.snapAsGroup;
